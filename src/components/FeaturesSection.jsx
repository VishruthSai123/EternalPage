  ...
  return (
    <section className="relative py-20 md:py-32 bg-navy overflow-hidden">
      ...
      >
        ...
        <div
          className={`flex gap-6 py-4 pl-8 animate-scroll ${isPaused ? 'pause-animation' : ''}`}
          style={{
            width: 'max-content',
          }}
        >
