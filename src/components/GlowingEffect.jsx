...
const GlowingEffect = memo(({
  ...
  const handleMove = useCallback(
    (e) => {
      ...
      animationFrameRef.current = requestAnimationFrame(() => {
        ...
        const animateAngle = (currentTime) => {
  ...
  const gradientValue = variant === 'white'
        ...
        >
          <div
            style={{
              ...
              maskImage: `linear-gradient(#0000, #0000), conic-gradient(from calc((var(--start) - ${spread}) * 1deg), #00000000 0deg, #fff, #00000000 calc(${spread} * 2deg))`,
              WebkitMaskImage: `linear-gradient(#0000, #0000), conic-gradient(from calc((var(--start) - ${spread}) * 1deg), #00000000 0deg, #fff, #00000000 calc(${spread} * 2deg))`,
            }}
          />
        </div>
      </div>
